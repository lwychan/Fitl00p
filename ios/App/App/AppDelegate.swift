...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        // Re-register HealthKit observer queries so background delivery
        // works when iOS launches the app just to deliver new Health data.
    ...
    // Forwarded to @capacitor/push-notifications — required for its
    // register()/addListener('registration'/'registrationError') calls
    // to ever resolve. See https://capacitorjs.com/docs/apis/push-notifications
